...
This agent's resources (`scripts/`, `data/`) live at the project root, not
next to this agent definition — unlike a skill, an agent has no directory of
its own that paths auto-resolve against. Anchor on the project root:

```
MUD_ROOT=/Users/scottburgholzer/Documents/examproco/claude-code-camp-2026-Q2/week0_explore/explore_architecture/03_subagent_sdk
```
